...
function assignKnot(deg: number, prm: number[]) {
 ...
 */
function deBoorKnots(deg: number, prm: number[]) {
...
function deBoorKnots2(deg: number, prm: number[]) {
 ...
 */
function calcGreville(deg: number, knot: number[]) {
 ...
 * t : parametric point
 */
function allBernstein(n: number, t: number) {
 ...
 * t : parameteric point
 */
function pointOnBezierCurve(ctrl: Vector[], t: number) {
...
function derBezier(ctrl: Vector[], t: number, q: Vector[] = []) {
...
function dersBezier(ctrl: Vector[], t: number, n = 2) {
...
function elevateDegreeBezier(ctrl: Vector[]) {
 ...
 * t : parameteric point
 */
function deCasteljau1(ctrl: Vector[], t: number) {
 ...
 * t : parameteric point
 */
function findIndexSpan(deg: number, knot: number[], n: number, t: number) {
 ...
 * t : parameteric point
 */
function basisFuncs(deg: number, knot: number[], span: number, t: number) {
	...
	for (let j = 1; j <= deg; j++) {
		...
		for (let k = 0; k < j; k++) {
			...
			const tmp: number = ni[k] / (right[k + 1] + left[j - k]);
 ...
 * t : parameteric point
 */
function dersBasisFunc(deg: number, knot: number[], span: number, n: number, t: number) {
 ...
 * t : parameteric point
*/
function curvePoint(deg: number, knot: number[], ctrl: Vector[], t: number) {
 ...
 */
function curveDers(deg: number, knot: number[], ctrl: Vector[], t: number, n = 2) {
...
*/
function surfacePoint(n: number, m: number, degU: number, degV: number, knotU: number[], knotV: number[], ctrl: Vector[][], s: number, t: number) {
 ...
 */
function surfaceDers(n: number, m: number, degU: number, degV: number, knotU: number[], knotV: number[], ctrl: Vector[][], s: number, t: number, d = 2) {
 ...
 * t : parameteric point
*/
function nurbsCurvePoint(deg: number, knot: number[], ctrl: Vector[], t: number) {
 ...
 * n : order of the highest derivative to compute (default value is 2)
 */
function nurbsCurveDers(deg: number, knot: number[], ctrl: Vector[], t: number, n = 2) {
 ...
 */
function binomial(k: number, i: number) {
 ...
 * s, t : parametric points
 */
function nurbsSurfacePoint(n: number, m: number, degU: number, degV: number, knotU: number[], knotV: number[], ctrl: Vector[][], s: number, t: number) {
 ...
 */
function nurbsSurfaceDers(n: number, m: number, degU: number, degV: number, knotU: number[], knotV: number[], ctrl: Vector[][], s: number, t: number, d = 2) {
...
function split(deg: number, knot: number[], ctrl: Vector[], t: number) {
 ...
 * r : r times insertion
*/
function knotInsert(deg: number, knot: number[], ctrl: Vector[], t: number, r = 1) {
...
function surfKnotInsert(deg_u: number, deg_v: number, knot_u: number[], knot_v: number[], ctrl: Vector[][], s: number, t: number) {
	...
	function calcCtrl(span: number, low: number, deg: number, alpha: number[], ctrl: Vector[]) {
 ...
 *
 */
function knotsRemoval(deg: number, knot: number[], ctrl: Vector[], u: number, num = 1, tol = 1e-4) {
...
function knotMults(knot: number[]) {
...
function decomposeCurve(deg: number, knot: number[], ctrl: Vector[]) {
 ...
 *
 */
function elevateDegree(deg: number, knot: number[], ctrl: Vector[], degInc: number) {
...
function reverseDirection(knots: number[], ctrlp: Vector[]) { // inpur array will be changed
 ...
 */
function makeNurbsCircle(o: Vector, x: Vector, y: Vector, r: number, a0: number, a1: number) {
...
function intersect3DLines(p0: Vector, d0: Vector, p1: Vector, d1: Vector) {
	...
	const c1 = p0.z + d0.z * x[0];
	const c2 = p1.z + d1.z * x[1];

	if (c1 - c2 < 1e-9) {

		const res = p1.add(d1.mul(x[1]));
		return res;
 ...
 */
function globalCurveInterp(deg: number, prm: number[], knot: number[], pts: Vector[]) {
 ...
 */
function solve(a: number[][], pts: Vector[]) {
 ...
 */
function weightedCtrlp(v3: Vector | Vector[], weight: number | number[]) {

	if (Array.isArray(v3) && Array.isArray(weight)) {
	...
	} else if (!Array.isArray(v3) && !Array.isArray(weight)) {
		...
		throw new Error("v3 and weight must both be arrays or both be scalars");

	}

}

function deWeight(v4: Vector | Vector[]) {
