...
(function (curvy) {
    curvy.Parametric.prototype.toThreeGeometry = function () {
        return tessellateCurve(this);
    };

    curvy.NurbsSurface.prototype.toThreeGeometry = function () {
...
function meshCurve(crv) {}

function meshSurface(srf) {}

function toThree(obj) {}

/*

import { toThree } from 'ConversionToThree.js'

parametric.prototype.toThree = toThree;
