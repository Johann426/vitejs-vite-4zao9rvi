class DataEx {
    ...
    IGES(editor) {
        ...
        for (let j = 0; j < group.length; j++) {
            // Level Property (Type 406, Form 3)
        ...
        for (let j = 0; j < surfs.length; j++) {
            ...
            const n =
                1 +
                Ceil(s.knot[0].length / 3) +
                Ceil(s.knot[1].length / 3) +
                Ceil(s.weights.length / 3) +
                s.ctrlPoints.length +
                2;
            const stat = "00000000"; // 00: visible, 00: Independent, 00: Geometry, 00:Hierarchy
            const row1 =
        ...
        for (let j = 0; j < group.length; j++) {
            // loop over group (Type 406, Form 3)
